...
type BpfTPDebugKafkaRequestData struct {
	_             structs.HostLayout
	CorrelationId int32
}

type BpfTPDebugKafkaStateData struct {
	_           structs.HostLayout
	MessageSize int32
}

type BpfTPDebugKafkaStateKey struct {
	_         structs.HostLayout
...
const (
	...
	BpfTPDebugProtocolTypeK_protocolTypeKafka    BpfTPDebugProtocolType = 3
)
