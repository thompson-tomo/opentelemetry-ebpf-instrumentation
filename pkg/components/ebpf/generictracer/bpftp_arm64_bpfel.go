...
type BpfTPKafkaRequestData struct {
	_             structs.HostLayout
	CorrelationId int32
}

type BpfTPKafkaStateData struct {
	_           structs.HostLayout
	MessageSize int32
}

type BpfTPKafkaStateKey struct {
	_         structs.HostLayout
...
const (
	...
	BpfTPProtocolTypeK_protocolTypeKafka    BpfTPProtocolType = 3
)
