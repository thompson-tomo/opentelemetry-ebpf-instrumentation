...
type BpfDebugKafkaRequestData struct {
	_             structs.HostLayout
	CorrelationId int32
}

type BpfDebugKafkaStateData struct {
	_           structs.HostLayout
	MessageSize int32
}

type BpfDebugKafkaStateKey struct {
	_         structs.HostLayout
...
const (
	...
	BpfDebugProtocolTypeK_protocolTypeKafka    BpfDebugProtocolType = 3
)
